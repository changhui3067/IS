...
public class IntelligentService {
    ...
    static IntelligentService instance;

    ServiceEventBus seb = new ServiceEventBusEngine();

    private IntelligentService() throws JMSException {
        String[] eventTypes = SubscriberMetadataProvider.getEventTypes();
...
//                        continue;
                    ...
                    try {
                        ...
                        EventReaction er = (EventReaction) clazz.newInstance();
                        er.onEvent(event);
